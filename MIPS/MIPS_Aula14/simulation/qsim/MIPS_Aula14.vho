...
SIGNAL \Banco_Registradores|saidaA[3]~1_combout\ : std_logic;
...
SIGNAL \Banco_Registradores|ALT_INV_saidaA[3]~1_combout\ : std_logic;
...
\Banco_Registradores|ALT_INV_saidaA[3]~1_combout\ <= NOT \Banco_Registradores|saidaA[3]~1_combout\;
...
-- pragma translate_on
PORT MAP (
	i => \Banco_Registradores|saidaA[3]~1_combout\,
	devoe => ww_devoe,
	o => \ULA_A[2]~output_o\);
...
-- Equation(s):
-- \somadorConstante|Add0~17_sumout\ = SUM(( \PC|DOUT\(2) ) + ( VCC ) + ( !VCC ))
-- \somadorConstante|Add0~18\ = CARRY(( \PC|DOUT\(2) ) + ( VCC ) + ( !VCC ))
...
-- Equation(s):
-- \somadorConstante|Add0~21_sumout\ = SUM(( \PC|DOUT\(3) ) + ( GND ) + ( \somadorConstante|Add0~18\ ))
-- \somadorConstante|Add0~22\ = CARRY(( \PC|DOUT\(3) ) + ( GND ) + ( \somadorConstante|Add0~18\ ))
...
-- Equation(s):
-- \somadorConstante|Add0~13_sumout\ = SUM(( \PC|DOUT\(4) ) + ( GND ) + ( \somadorConstante|Add0~22\ ))
-- \somadorConstante|Add0~14\ = CARRY(( \PC|DOUT\(4) ) + ( GND ) + ( \somadorConstante|Add0~22\ ))
...
-- Equation(s):
-- \ROM1|memROM~2_combout\ = ( \PC|DOUT\(2) & ( \PC|DOUT\(3) & ( (!\PC|DOUT\(7) & (!\PC|DOUT\(6) & (!\PC|DOUT\(5) & !\PC|DOUT\(4)))) ) ) )
...
-- Equation(s):
-- \somadorMux|Add0~13_sumout\ = SUM(( \somadorConstante|Add0~13_sumout\ ) + ( \ROM1|memROM~2_combout\ ) + ( !VCC ))
-- \somadorMux|Add0~14\ = CARRY(( \somadorConstante|Add0~13_sumout\ ) + ( \ROM1|memROM~2_combout\ ) + ( !VCC ))
...
-- pragma translate_on
PORT MAP (
	datad => \somadorConstante|ALT_INV_Add0~13_sumout\,
...
-- Equation(s):
-- \ROM1|memROM~0_combout\ = ( \PC|DOUT\(5) ) # ( !\PC|DOUT\(5) & ( (((\PC|DOUT\(2) & \PC|DOUT\(3))) # (\PC|DOUT\(4))) # (\PC|DOUT\(6)) ) )
...
-- Equation(s):
-- \ROM1|memROM~1_combout\ = ( \PC|DOUT\(5) ) # ( !\PC|DOUT\(5) & ( ((!\PC|DOUT\(2) & (\PC|DOUT\(3) & \PC|DOUT\(4))) # (\PC|DOUT\(2) & ((\PC|DOUT\(4)) # (\PC|DOUT\(3))))) # (\PC|DOUT\(6)) ) )
...
\Banco_Registradores|saidaA[3]~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \Banco_Registradores|saidaA[3]~1_combout\ = (!\PC|DOUT\(7) & (!\PC|DOUT\(6) & (!\PC|DOUT\(5) & !\PC|DOUT\(4))))
...
PORT MAP (
	...
	datac => \PC|ALT_INV_DOUT\(5),
	datad => \PC|ALT_INV_DOUT\(4),
	combout => \Banco_Registradores|saidaA[3]~1_combout\);

\ULA1|Add0~130\ : cyclonev_lcell_comb
-- Equation(s):
-- \ULA1|Add0~130_cout\ = CARRY(( (\ROM1|memROM~2_combout\ & (((\ROM1|memROM~1_combout\ & \ROM1|memROM~0_combout\)) # (\PC|DOUT\(7)))) ) + ( VCC ) + ( !VCC ))

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000000000000000000000000000000000000000010100010101",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \ULA1|Add0~1_sumout\ = SUM(( (\ROM1|memROM~2_combout\ & (((\ROM1|memROM~1_combout\ & \ROM1|memROM~0_combout\)) # (\PC|DOUT\(7)))) ) + ( \Banco_Registradores|saidaA[0]~0_combout\ ) + ( \ULA1|Add0~130_cout\ ))
-- \ULA1|Add0~2\ = CARRY(( (\ROM1|memROM~2_combout\ & (((\ROM1|memROM~1_combout\ & \ROM1|memROM~0_combout\)) # (\PC|DOUT\(7)))) ) + ( \Banco_Registradores|saidaA[0]~0_combout\ ) + ( \ULA1|Add0~130_cout\ ))

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000111111110000000000000000000000000000000101010101",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \ROM1|ALT_INV_memROM~2_combout\,
	...
	dataf => \Banco_Registradores|ALT_INV_saidaA[0]~0_combout\,
...
-- Equation(s):
-- \ULA1|Add0~5_sumout\ = SUM(( (\ROM1|memROM~2_combout\ & (((\ROM1|memROM~0_combout\ & \ROM1|memROM~1_combout\)) # (\PC|DOUT\(7)))) ) + ( GND ) + ( \ULA1|Add0~2\ ))
-- \ULA1|Add0~6\ = CARRY(( (\ROM1|memROM~2_combout\ & (((\ROM1|memROM~0_combout\ & \ROM1|memROM~1_combout\)) # (\PC|DOUT\(7)))) ) + ( GND ) + ( \ULA1|Add0~2\ ))

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000111111111111111100000000000000000001000100010101",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \ROM1|ALT_INV_memROM~2_combout\,
...
-- Equation(s):
-- \ULA1|Add0~9_sumout\ = SUM(( \Banco_Registradores|saidaA[3]~1_combout\ ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~1_combout\) # (!\ROM1|memROM~0_combout\)))) ) + ( \ULA1|Add0~6\ ))
-- \ULA1|Add0~10\ = CARRY(( \Banco_Registradores|saidaA[3]~1_combout\ ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~1_combout\) # (!\ROM1|memROM~0_combout\)))) ) + ( \ULA1|Add0~6\ ))

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000101110111011111100000000000000000000000011111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \ROM1|ALT_INV_memROM~2_combout\,
	...
	datad => \Banco_Registradores|ALT_INV_saidaA[3]~1_combout\,
...
-- Equation(s):
-- \ULA1|Add0~13_sumout\ = SUM(( \Banco_Registradores|saidaA[3]~1_combout\ ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~10\ ))
-- \ULA1|Add0~14\ = CARRY(( \Banco_Registradores|saidaA[3]~1_combout\ ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~10\ ))
...
-- Equation(s):
-- \ULA1|Add0~17_sumout\ = SUM(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~14\ ))
-- \ULA1|Add0~18\ = CARRY(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~14\ ))

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000101110111011111100000000000000000000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \ROM1|ALT_INV_memROM~2_combout\,
...
-- Equation(s):
-- \ULA1|Add0~21_sumout\ = SUM(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~18\ ))
-- \ULA1|Add0~22\ = CARRY(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~18\ ))
...
-- Equation(s):
-- \ULA1|Add0~25_sumout\ = SUM(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~22\ ))
-- \ULA1|Add0~26\ = CARRY(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~22\ ))
...
-- Equation(s):
-- \ULA1|Add0~29_sumout\ = SUM(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~26\ ))
-- \ULA1|Add0~30\ = CARRY(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~26\ ))
...
-- Equation(s):
-- \ULA1|Add0~33_sumout\ = SUM(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~30\ ))
-- \ULA1|Add0~34\ = CARRY(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~30\ ))
...
-- Equation(s):
-- \ULA1|Add0~37_sumout\ = SUM(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~34\ ))
-- \ULA1|Add0~38\ = CARRY(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~34\ ))
...
-- Equation(s):
-- \ULA1|Add0~41_sumout\ = SUM(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~38\ ))
-- \ULA1|Add0~42\ = CARRY(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~38\ ))
...
-- Equation(s):
-- \ULA1|Add0~45_sumout\ = SUM(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~42\ ))
-- \ULA1|Add0~46\ = CARRY(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~42\ ))
...
-- Equation(s):
-- \ULA1|Add0~49_sumout\ = SUM(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~46\ ))
-- \ULA1|Add0~50\ = CARRY(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~46\ ))
...
-- Equation(s):
-- \ULA1|Add0~53_sumout\ = SUM(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~50\ ))
-- \ULA1|Add0~54\ = CARRY(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~50\ ))
...
-- Equation(s):
-- \ULA1|Add0~57_sumout\ = SUM(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~54\ ))
-- \ULA1|Add0~58\ = CARRY(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~54\ ))
...
-- Equation(s):
-- \ULA1|Add0~61_sumout\ = SUM(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~58\ ))
-- \ULA1|Add0~62\ = CARRY(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~58\ ))
...
-- Equation(s):
-- \ULA1|Add0~65_sumout\ = SUM(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~62\ ))
-- \ULA1|Add0~66\ = CARRY(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~62\ ))
...
-- Equation(s):
-- \ULA1|Add0~69_sumout\ = SUM(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~66\ ))
-- \ULA1|Add0~70\ = CARRY(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~66\ ))
...
-- Equation(s):
-- \ULA1|Add0~73_sumout\ = SUM(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~70\ ))
-- \ULA1|Add0~74\ = CARRY(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~70\ ))
...
-- Equation(s):
-- \ULA1|Add0~77_sumout\ = SUM(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~74\ ))
-- \ULA1|Add0~78\ = CARRY(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~74\ ))
...
-- Equation(s):
-- \ULA1|Add0~81_sumout\ = SUM(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~78\ ))
-- \ULA1|Add0~82\ = CARRY(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~78\ ))
...
-- Equation(s):
-- \ULA1|Add0~85_sumout\ = SUM(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~82\ ))
-- \ULA1|Add0~86\ = CARRY(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~82\ ))
...
-- Equation(s):
-- \ULA1|Add0~89_sumout\ = SUM(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~86\ ))
-- \ULA1|Add0~90\ = CARRY(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~86\ ))
...
-- Equation(s):
-- \ULA1|Add0~93_sumout\ = SUM(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~90\ ))
-- \ULA1|Add0~94\ = CARRY(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~90\ ))
...
-- Equation(s):
-- \ULA1|Add0~97_sumout\ = SUM(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~94\ ))
-- \ULA1|Add0~98\ = CARRY(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~94\ ))
...
-- Equation(s):
-- \ULA1|Add0~101_sumout\ = SUM(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~98\ ))
-- \ULA1|Add0~102\ = CARRY(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~98\ ))
...
-- Equation(s):
-- \ULA1|Add0~105_sumout\ = SUM(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~102\ ))
-- \ULA1|Add0~106\ = CARRY(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~102\ ))
...
-- Equation(s):
-- \ULA1|Add0~109_sumout\ = SUM(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~106\ ))
-- \ULA1|Add0~110\ = CARRY(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~106\ ))
...
-- Equation(s):
-- \ULA1|Add0~113_sumout\ = SUM(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~110\ ))
-- \ULA1|Add0~114\ = CARRY(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~110\ ))
...
-- Equation(s):
-- \ULA1|Add0~117_sumout\ = SUM(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~114\ ))
-- \ULA1|Add0~118\ = CARRY(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~114\ ))
...
-- Equation(s):
-- \ULA1|Add0~121_sumout\ = SUM(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~118\ ))
-- \ULA1|Add0~122\ = CARRY(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~118\ ))
...
-- Equation(s):
-- \ULA1|Add0~125_sumout\ = SUM(( GND ) + ( (\ROM1|memROM~2_combout\ & (!\PC|DOUT\(7) & ((!\ROM1|memROM~0_combout\) # (!\ROM1|memROM~1_combout\)))) ) + ( \ULA1|Add0~122\ ))
...
-- Equation(s):
-- \AND_FLAG_ZERO~7_combout\ = ( !\PC|DOUT\(6) & ( (!\PC|DOUT\(7) & (!\PC|DOUT\(5) & (!\PC|DOUT\(4) & !\PC|DOUT\(3)))) ) )
...
-- Equation(s):
-- \AND_FLAG_ZERO~0_combout\ = ( !\ULA1|Add0~17_sumout\ & ( \AND_FLAG_ZERO~7_combout\ & ( (!\ULA1|Add0~1_sumout\ & (!\ULA1|Add0~5_sumout\ & (!\ULA1|Add0~9_sumout\ & !\ULA1|Add0~13_sumout\))) ) ) )
...
PORT MAP (
	...
	dataf => \ALT_INV_AND_FLAG_ZERO~7_combout\,
	combout => \AND_FLAG_ZERO~0_combout\);

\AND_FLAG_ZERO~6\ : cyclonev_lcell_comb
-- Equation(s):
-- \AND_FLAG_ZERO~6_combout\ = ( !\ULA1|Add0~53_sumout\ & ( !\ULA1|Add0~61_sumout\ & ( (!\ULA1|Add0~101_sumout\ & (!\ULA1|Add0~41_sumout\ & (!\ULA1|Add0~45_sumout\ & !\ULA1|Add0~49_sumout\))) ) ) )
...
PORT MAP (
	...
	datae => \ULA1|ALT_INV_Add0~53_sumout\,
	dataf => \ULA1|ALT_INV_Add0~61_sumout\,
	combout => \AND_FLAG_ZERO~6_combout\);

\AND_FLAG_ZERO~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \AND_FLAG_ZERO~1_combout\ = ( \AND_FLAG_ZERO~0_combout\ & ( \AND_FLAG_ZERO~6_combout\ & ( (!\ULA1|Add0~81_sumout\ & (!\ULA1|Add0~85_sumout\ & (!\ULA1|Add0~89_sumout\ & !\ULA1|Add0~93_sumout\))) ) ) )
...
PORT MAP (
	...
	datae => \ALT_INV_AND_FLAG_ZERO~0_combout\,
	dataf => \ALT_INV_AND_FLAG_ZERO~6_combout\,
	combout => \AND_FLAG_ZERO~1_combout\);

\AND_FLAG_ZERO~4\ : cyclonev_lcell_comb
-- Equation(s):
-- \AND_FLAG_ZERO~4_combout\ = ( !\ULA1|Add0~25_sumout\ & ( !\ULA1|Add0~29_sumout\ & ( (!\ULA1|Add0~33_sumout\ & (!\ULA1|Add0~37_sumout\ & (!\ULA1|Add0~57_sumout\ & !\ULA1|Add0~21_sumout\))) ) ) )
...
PORT MAP (
	...
	datae => \ULA1|ALT_INV_Add0~25_sumout\,
	dataf => \ULA1|ALT_INV_Add0~29_sumout\,
	combout => \AND_FLAG_ZERO~4_combout\);

\AND_FLAG_ZERO~5\ : cyclonev_lcell_comb
-- Equation(s):
-- \AND_FLAG_ZERO~5_combout\ = (!\ULA1|Add0~73_sumout\ & (!\ULA1|Add0~65_sumout\ & !\ULA1|Add0~69_sumout\))
...
-- Equation(s):
-- \AND_FLAG_ZERO~2_combout\ = ( \AND_FLAG_ZERO~4_combout\ & ( \AND_FLAG_ZERO~5_combout\ & ( (!\ULA1|Add0~77_sumout\ & (!\ULA1|Add0~97_sumout\ & (!\ULA1|Add0~105_sumout\ & !\ULA1|Add0~109_sumout\))) ) ) )
...
PORT MAP (
	...
	datad => \ULA1|ALT_INV_Add0~109_sumout\,
	datae => \ALT_INV_AND_FLAG_ZERO~4_combout\,
	dataf => \ALT_INV_AND_FLAG_ZERO~5_combout\,
	combout => \AND_FLAG_ZERO~2_combout\);

\AND_FLAG_ZERO~3\ : cyclonev_lcell_comb
-- Equation(s):
-- \AND_FLAG_ZERO~3_combout\ = ( \AND_FLAG_ZERO~1_combout\ & ( \AND_FLAG_ZERO~2_combout\ & ( (((\ULA1|Add0~125_sumout\) # (\ULA1|Add0~121_sumout\)) # (\ULA1|Add0~117_sumout\)) # (\ULA1|Add0~113_sumout\) ) ) ) # ( !\AND_FLAG_ZERO~1_combout\ & ( 
-- \AND_FLAG_ZERO~2_combout\ ) ) # ( \AND_FLAG_ZERO~1_combout\ & ( !\AND_FLAG_ZERO~2_combout\ ) ) # ( !\AND_FLAG_ZERO~1_combout\ & ( !\AND_FLAG_ZERO~2_combout\ ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \ULA1|ALT_INV_Add0~113_sumout\,
	datab => \ULA1|ALT_INV_Add0~117_sumout\,
	datac => \ULA1|ALT_INV_Add0~121_sumout\,
	datad => \ULA1|ALT_INV_Add0~125_sumout\,
	datae => \ALT_INV_AND_FLAG_ZERO~1_combout\,
	dataf => \ALT_INV_AND_FLAG_ZERO~2_combout\,
...
PORT MAP (
	clk => \CLOCK_50~input_o\,
	d => \somadorMux|Add0~13_sumout\,
	asdata => \somadorConstante|Add0~13_sumout\,
	sload => \AND_FLAG_ZERO~3_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \PC|DOUT\(4));
...
-- Equation(s):
-- \somadorMux|Add0~9_sumout\ = SUM(( \somadorConstante|Add0~9_sumout\ ) + ( \ROM1|memROM~2_combout\ ) + ( \somadorMux|Add0~14\ ))
-- \somadorMux|Add0~10\ = CARRY(( \somadorConstante|Add0~9_sumout\ ) + ( \ROM1|memROM~2_combout\ ) + ( \somadorMux|Add0~14\ ))
...
-- pragma translate_on
PORT MAP (
	datad => \somadorConstante|ALT_INV_Add0~9_sumout\,
	dataf => \ROM1|ALT_INV_memROM~2_combout\,
...
PORT MAP (
	clk => \CLOCK_50~input_o\,
	d => \somadorMux|Add0~9_sumout\,
	asdata => \somadorConstante|Add0~9_sumout\,
	sload => \AND_FLAG_ZERO~3_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \PC|DOUT\(5));
...
-- Equation(s):
-- \somadorMux|Add0~5_sumout\ = SUM(( \somadorConstante|Add0~5_sumout\ ) + ( \ROM1|memROM~2_combout\ ) + ( \somadorMux|Add0~10\ ))
-- \somadorMux|Add0~6\ = CARRY(( \somadorConstante|Add0~5_sumout\ ) + ( \ROM1|memROM~2_combout\ ) + ( \somadorMux|Add0~10\ ))
...
-- pragma translate_on
PORT MAP (
	datad => \somadorConstante|ALT_INV_Add0~5_sumout\,
	dataf => \ROM1|ALT_INV_memROM~2_combout\,
...
PORT MAP (
	clk => \CLOCK_50~input_o\,
	d => \somadorMux|Add0~5_sumout\,
	asdata => \somadorConstante|Add0~5_sumout\,
	sload => \AND_FLAG_ZERO~3_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \PC|DOUT\(6));
...
-- Equation(s):
-- \somadorMux|Add0~1_sumout\ = SUM(( \somadorConstante|Add0~1_sumout\ ) + ( \ROM1|memROM~2_combout\ ) + ( \somadorMux|Add0~6\ ))
...
-- pragma translate_on
PORT MAP (
	datad => \somadorConstante|ALT_INV_Add0~1_sumout\,
	dataf => \ROM1|ALT_INV_memROM~2_combout\,
...
PORT MAP (
	clk => \CLOCK_50~input_o\,
	d => \somadorMux|Add0~1_sumout\,
	asdata => \somadorConstante|Add0~1_sumout\,
	sload => \AND_FLAG_ZERO~3_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \PC|DOUT\(7));
...
-- Equation(s):
-- \Banco_Registradores|saidaA[0]~0_combout\ = ( !\PC|DOUT\(5) & ( !\PC|DOUT\(4) & ( (!\PC|DOUT\(7) & (!\PC|DOUT\(6) & ((\PC|DOUT\(3)) # (\PC|DOUT\(2))))) ) ) )
...
-- Equation(s):
-- \Decoder|OUTPUT[1]~0_combout\ = (\ROM1|memROM~2_combout\ & (((\ROM1|memROM~0_combout\ & \ROM1|memROM~1_combout\)) # (\PC|DOUT\(7))))
